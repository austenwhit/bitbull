...
varbitbull = require("../../index.js");

describe("transaction.js", function () {

  var transaction =bitbull.transaction;
  ...
  describe("#createTransaction", function () {
    ...
    it("should create transaction without second signature from keys", function () {
      var secretKey =bitbull.ECPair.fromSeed("secret");
    ...
    describe("returned transaction", function () {
      ...
      it("should be signed correctly", function () {
        var result =bitbull.crypto.verify(trs);
        result.should.equal(true);
      });

      it("should be deserialised correctly", function () {
        var deserialisedTx =bitbull.crypto.fromBytes(bitbull.crypto.getBytes(trs).toString("hex"));
  ...
  describe("createTransaction and try to tamper signature", function(){
    ...
    it("should not validate overflown signatures", function(){
      ...
      var old_transaction =bitbull.transaction.createTransaction('AacRfTLtxAkR3Mind1XdPCddj1uDkHtwzD', 1, null, 'randomstring');
      ...
      */
      ...
      // console.log("TXID " +bitbull.crypto.getId(old_transaction));
      // console.log("VERIFY " +bitbull.crypto.verify(old_transaction));
      // console.log("SIG " + old_transaction.signature + "\n");

     bitbull.crypto.verify(old_transaction).should.equal(true);
     ...
     bitbull.crypto.verify(old_transaction).should.equal(false);
  ...
  describe("#createTransaction with second secret", function () {
    ...
    var keys =bitbull.crypto.getKeys(secondSecret);
    ...
    describe("returned transaction", function () {
      ...
      it("should be second signed correctly", function () {
        var result =bitbull.crypto.verifySecondSignature(trs, keys.publicKey);
        (result).should.equal(true);
      });
