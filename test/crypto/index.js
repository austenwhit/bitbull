...
describe("different networks", function () {
  ...
  it("validate address on tesnet should be ok", function () {
    bitbull.crypto.setNetworkVersion(0x52);
    bitbull.crypto.getNetworkVersion().should.equal(0x52);
    var validate = bitbull.crypto.validateAddress("a6fpb1BJZq4otWiVsBcuLG1ZGs5WsqqQtH");
    (validate).should.equal(true);
    bitbull.crypto.setNetworkVersion(0x17);
    bitbull.crypto.getNetworkVersion().should.equal(0x17);
  });
});

describe("delegate.js", function () {
  var delegate = bitbull.delegate;
  ...
  describe("#createDelegate", function () {
    ...
    describe("returned delegate", function () {
      var keys = bitbull.crypto.getKeys("secret");
      var secondKeys = bitbull.crypto.getKeys("secret 2");
      ...
      it("should be second signed correctly", function () {
        var result = bitbull.crypto.verifySecondSignature(trs, secondKeys.publicKey);
        (result).should.be.ok;
      });
