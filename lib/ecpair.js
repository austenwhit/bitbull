 ...
 * @param {Network} [options.network=networks.bitbull]
 */
function ECPair (d, Q, options) {
  ...
  /** @type {Network} */ this.network = options.network || NETWORKS.bitbull
}
...
/**
 * @param {Buffer} buffer
 * @param {Network} [network=networks.bitbull]
 * @returns {ECPair}
 */
...
ECPair.fromWIF = function (string, network) {
  ...
  // network
    ...
    network = network || NETWORKS.bitbull
